/**
 * @file src/workflows/human-input.ts
...
import type { HumanInputDescriptorV1 } from "../profile/types.js";
...
export async function recordHumanInputLocked(
  ...
  const payload = await admitHumanInput(root, profile, run, descriptor, input);
