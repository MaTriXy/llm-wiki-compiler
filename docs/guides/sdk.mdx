...
`llmwiki-core` returns `WikiCore`: knowledge compilation, profiles, domain records,
...
```ts
import { createWikiCore, type RecordIntentV1 } from "llmwiki-core";
